...
>> P(Fraternal Twin) = 1/300
>> P(Identical Twin) = 1/125
>>
>> P(Identical Twin|Twin) = P(Twin|Identical Twin)*P(Identical Twin) / (P(Twin|Identical Twin)*P(Identical Twin) + (P(Twin|Fraternal Twin)*P(Fraternal Twin))  
>> 
>> P(Identical Twin|Twin) = (1)(1/300) / ((1)(1/300) + (1)(1/125)) ~ 0.294
>>
